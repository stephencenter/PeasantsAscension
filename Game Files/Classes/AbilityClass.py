...
backstab = Ability("Backstab", """The user sneaks up on their opponent and deals a [125 + Dexterity]% critical strike.
This move has increased priority and will always go first.""", 2)
