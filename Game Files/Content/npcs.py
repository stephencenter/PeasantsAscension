...
solou_convo_1 = Conversation([
    "H-hello! My name is Solou, wizard in training! Well, the truth is that",
    "I'm actually a page for King Harconius II, but my one dream is to become",
    "a master sorceress! Uh, well anyway I'm here delivering a letter to a person",
    "named... oh wait a minute, what did you say your name was? Huzzah, this",
    "letter is for you then! As it is sensitive information, I am required by",
    "law to give it to you and then dispose of it with fire!                 ",
    "*Ahem*:                                                                 ",
    '   "As captain of the 7th Platoon of the Harconian Army, you are hereby",',
    "    entrusted with the following information and a mission. Princess Celeste,",
    "    daughter of His Majesty King Harconius II, has been kidnapped by the",
    "    Thexus, a group of incredibly skilled and well-trained assassins from the",
    "    island-nation of Thex. We know with 100% confidence her exact whereabouts,",
    "    but the main issue is actually getting there. The island of Thex is",
    "    encompassed by a seemingly indestructible barrier. It appears to be being",
    "    generated by magestite, causing any chance of dispelling it to be futile.",
    "    We need you to do everything in your power to figure out a way to",
    '    infiltrate the island and retrieve Celeste. Signed, Chancellor Zadael".',
    ...
    "I'm sure that my wizardry would be of great use to you, too!"], "solou_c1", active=True)
...
solou_convo_2 = Conversation(["No time to chat, we gotta get back to adventuring!"], "solou_c2")
...
joseph_convo_2 = Conversation(["Ah, Solou! Long time no see! I see you've taken up adventuring.",
...
joseph_convo_3 = Conversation(["Go visit my friend Azura in Parceon. She knows more about this than",
...
matthew_convo_5 = Conversation(["...", "*He looks quite depressed.*"], "matt_c5")
...
caesar_convo_1 = Conversation(["*Caesar, Fly's pet strawberry dragon, runs away and hides behind",
...
sakura_convo_1 = Conversation(['HALT! State your business! Ah, you want to see the King, do you?',
...
all_dialogue = [
    solou_convo_1, solou_convo_2, solou_quest_1,

    rivesh_convo_1, rivesh_convo_2, rivesh_convo_3, rivesh_convo_4, rivesh_quest_1,

    alfred_convo_1, alfred_convo_2, alfred_convo_3, alfred_quest_1,

    stewson_convo_1, stewson_convo_2, stewson_convo_3, stewson_quest_1,
    ...
    polmor_convo_1, polmor_convo_2, polmor_quest_1,
...
for dialogue in all_dialogue:
    for num, sentence in enumerate(dialogue.sentences):
        ...
        elif len(dialogue.sentences) == 1:
            continue

        elif len(sentence) < 60 and num + 1 != len(dialogue.sentences):
            print(dialogue.conv_id, num + 1, "too short", len(sentence))
