...
Calice: A massive town in the Province of Overshire. Despite its immense size, 
comparable to that of Overshire City, Valice has little to offer. Back during 
the Harconian Gem Rush, when thousands of tons of gems and ore were discovered
to be lying beneath the surface of Valice, the town grew tremendously in both
size and wealth. This wealth did not last, as the gems quickly became rarer and
rarer and are now nowhere to be seen. This, unfortunately, means that Valice is
both one of the biggest towns in Overshire, and also one of the poorest.""",
...
Sardooth: A ghost town. There has not been a single permanent inhabitant of 
this town for more than 75 years. It is completely run down, due to its proximity
to the ocean. The Arcadian oceans are extremely dangerous, with tsunamis being
extremely common. While this town may seem interesting and historic, there is 
nothing of value here.""", [], [], -1, -1, "sardooth")
...
all_towns = [town_nearton, town_southford, town_ambercreek, town_capwild, town_cesura, town_valice,
