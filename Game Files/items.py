...
bnz_cst = Armor('Bronze Chestpiece',
    'Simple chest armor crafted from bronze (+1 Defense).',
...
wiz_rob = Armor('Wizard Robe',
    'A silk robe woven with magic thread (+1 Magic Defense).',
...
irn_cst = Armor('Iron Chestpiece',
    'Decent body armor made from a solid metal (+3 Defense).',
    175, 60, 3, 'melee', 'body', 'warrior')
...
myst_rob = Armor('Mystical Robe',
    'A mysterious robe with strange symbols sewn into it (+3 Magic Defense)',
    175, 60, 3, 'magic', 'body', 'mage')
...
stl_cst = Armor('Steel Chestplate',
    'Strong chest armor smelted from refined iron (+5 Defense).',
...
elem_rob = Armor('Elemental Robe',
    'A leather robe enchanted with elemental power (+5 Magic Defense).',
    350, 120, 5, 'magic', 'body', 'mage')
